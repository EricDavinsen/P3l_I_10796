...
import com.example.p3l_i_10796.adapter.JadwalInstrukturAdapter
import com.example.p3l_i_10796.api.PresensiBookingApi
import com.example.p3l_i_10796.databinding.ActivityJadwalInstrukturBinding
...
class JadwalInstrukturActivity : AppCompatActivity() {
    ...
    private fun allData(id: Int) {
        ...
        val stringRequest: StringRequest = object :
            StringRequest(Method.GET, PresensiBookingApi.GET_JADWAL + id, Response.Listener { response ->
