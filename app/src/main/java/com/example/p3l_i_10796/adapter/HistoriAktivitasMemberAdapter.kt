...
class HistoriAktivitasMemberAdapter(private var historys: List<AktivitasMember>, context: Context): RecyclerView.Adapter<HistoriAktivitasMemberAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view = inflater.inflate(R.layout.activity_histori_aktivitas_member_adapter, parent, false)
